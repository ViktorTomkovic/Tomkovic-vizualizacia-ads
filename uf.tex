...
\section{Heuristiky na kompresiu cesty}
...
\label{img:komp1}
% ,width=0.4\textwidth
\includegraphics[height=0.36\textwidth]{obrazky/komp1.png}
}
\qquad
\subfloat[Úplná kompresia.]{
\label{img:komp2}
\includegraphics[height=0.18\textwidth]{obrazky/komp2.png}
}

\subfloat[Delenie cesty.]{
\label{img:komp3}
\includegraphics[height=0.24\textwidth]{obrazky/komp3.png}
}
\qquad
\subfloat[Pólenie cesty.]{
\label{img:komp4}
\includegraphics[height=0.30\textwidth]{obrazky/komp4.png}
}
...
je \emph{úplná kompresia} \citep{comp1}. Pri vykonávaní operácie \find, po 
...
\find\ pripojíme každý vrchol v ceste od vrcholu $x$ po koreň stromu na otca 
jeho otca (obr.~\ref{img:komp3}). Treťou heuristikou je \emph{pólenie cesty} 
\citep{comp2}. Pri vykonávaní operácie \find\  pripojíme každý druhý vrchol 
